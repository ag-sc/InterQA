...
public class Give_me_all_C_that_P_I extends QueryPattern{
	...
	/*
	  ...
	  Show me all conferences that took place in Berlin.
          Show me all conferences that took place in 2015.	
        */
	
	public Give_me_all_C_that_P_I(Lexicon lexicon,InstanceSource instances){
...
elements = new ArrayList<>();
	...
	public Set<String> buildSPARQLqueries() {
            ...
            switch (currentElement) {
                ...
                case 5: return sqb.BuildQueryForClassAndIndividualAndProperty(noun, indi, verb, LexicalEntry.SynArg.OBJECT);
